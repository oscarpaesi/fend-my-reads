        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Shelf title="Currently Reading" books={ this.state.books.filter((book) => book.status === 'Currently Reading') }/>
                <Shelf title="Want to Read" books={ this.state.books.filter((book) => book.status === 'Want to Read') }/>
                <Shelf title="Read" books={ this.state.books.filter((book) => book.status === 'Read') }/>
              </div>
            </div>
